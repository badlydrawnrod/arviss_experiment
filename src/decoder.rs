...
pub trait Decoder2 {
    ...
    fn fence(&mut self, instruction: RdFmPredRdRs1Succ) -> Self::Item;
...
pub fn decode2<T>(decoder: &mut (impl Decoder2 + Decoder2<Item = T>), machine_code: u32) -> T {
    // This function is generated by make_decoder.py. Do not edit.
    match bits(machine_code, 1, 0) {
        0x3 => {
            match bits(machine_code, 6, 2) {
                ...
                0x3 => {
                    match bits(machine_code, 14, 12) {
                        0x0 => return decoder.fence(Fence), // fence
                        0x1 => {
                            return decoder.i_type(
                                FenceI,
                                extract_iimmediate(machine_code),
