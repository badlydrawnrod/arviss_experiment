...
use crate::{
    handlers::{Rv32cHandler, Rv32fHandler, Rv32iHandler, Rv32mHandler},
    reg::Reg,
};
...
impl Rv32iHandler for Disassembler {
    type Item = String;
...
impl Rv32mHandler for Disassembler {
    type Item = String;
...
impl Rv32cHandler for Disassembler {
    type Item = String;
...
impl Rv32fHandler for Disassembler {
    type Item = String;
