...
pub trait Rv32iDispatcher {
    ...
    fn dispatch(&mut self, code: u32) -> <Self as Rv32iHandler>::Item
    where
        Self: Rv32iHandler;
}
...
where
    T: Rv32iHandler + Rv32iHandler<Item = U>,
{
    type Item = U;
...
pub trait Rv32imDispatcher {
    ...
    fn dispatch(&mut self, code: u32) -> <Self as Rv32iHandler>::Item
    where
        Self: Rv32iHandler + Rv32mHandler;
}

impl<T, U> Rv32imDispatcher for T
where
    T: Rv32iHandler + Rv32iHandler<Item = U> + Rv32mHandler + Rv32mHandler<Item = U>,
{
    type Item = U;
...
pub trait Rv32icDispatcher {
    ...
    fn dispatch(&mut self, code: u32) -> <Self as Rv32iHandler>::Item
    where
        Self: Rv32iHandler + Rv32cHandler;
}

impl<T, U> Rv32icDispatcher for T
where
    T: Rv32iHandler + Rv32iHandler<Item = U> + Rv32cHandler + Rv32cHandler<Item = U>,
{
    type Item = U;
...
pub trait Rv32imcDispatcher {
    ...
    fn dispatch(&mut self, code: u32) -> <Self as Rv32iHandler>::Item
    where
        Self: Rv32iHandler + Rv32mHandler + Rv32cHandler;
}
...
pub trait Rv32imfDispatcher {
    ...
    fn dispatch(&mut self, code: u32) -> <Self as Rv32iHandler>::Item
    where
        Self: Rv32iHandler + Rv32mHandler + Rv32fHandler;
}
...
pub trait Rv32imfcDispatcher {
    ...
    fn dispatch(&mut self, code: u32) -> <Self as Rv32iHandler>::Item
    where
        Self: Rv32iHandler + Rv32mHandler + Rv32fHandler + Rv32cHandler;
}
...
#[cfg(test)]
mod test {
    use super::{Rv32cHandler, Rv32fHandler, Rv32iHandler, Rv32mHandler};
    use crate::reg::Reg;
